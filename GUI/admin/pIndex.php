...
<div id="main">
    ...
    <div class="col-xs-12">
        <div class="menu">
            ...
            <a href="category.html" class="col-md-2 col-sm-5 col-xs-5">
                <i class="fa fa-grav"></i> <span> Quản Lý Loại Sản Phẩm</span>
            </a>
            <a href="factory.html" class="col-md-2 col-sm-5 col-xs-5">
                <i class="fa fa-flag"></i> <span> Quản Lý Hãng Sản Xuất</span>
            </a>
            <a href="oder.html" class="col-md-2 col-sm-5 col-xs-5">
