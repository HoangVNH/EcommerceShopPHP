<div id="main">
    ...
    <div class="col-xs-12">
        ...
        <form id="admin-form" class="form-horizontal col-md-12" method="post" action="?a=107" enctype="multipart/form-data" role="form">
            <input type="hidden" name="ex" value="new" />
            
            <div class="form-group">
                <label for="title" class="col-sm-4 control-label ">Tên hãng sản xuất <span style="color:red;">*</span></label>
                <div class="col-sm-5">
            ...
            <div class="form-group" >
                <label class="col-sm-4 control-label">Logo hãng sản xuất <span style="color:red;">*</span></label>
                <div class="col-sm-5">
